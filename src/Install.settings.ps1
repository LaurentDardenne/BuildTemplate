...
Properties {
    ...
    $PSGallery=@{
       ...
       Scripts=@('Pester','PsScriptAnalyzer')
     }
    ...
    $MyGet=@{
       Modules=@('Log4Posh','MeasureLocalizedData','DTW.PS.FileSystem','Template','OptimizationRules','PSParameterSetRules',
                  ...
                  Publish-Script -Path G:\PS\ProjectTools\Show-BalloonTip.ps1 -Repository OttMatt 
                  install-Script -name 'Show-BalloonTip' -Repository OttoMatt -Scope allusers 
